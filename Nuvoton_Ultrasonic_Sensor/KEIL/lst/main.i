...
# 746 "C:\\Keil_v5\\ARM\\ARMCLANG\\Bin\\..\\include\\arm_acle.h" 3
...
# 292 "../../../../Library/StdDriver/inc\\clk.h"
//AHBCLK
# 345 "../../../../Library/StdDriver/inc\\clk.h"
//APBCLK0
# 430 "../../../../Library/StdDriver/inc\\clk.h"
//APBCLK1
 ...
 void TMR1_IRQHandler(void)
{
 ...
 TIMER_ClearIntFlag(((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL))); // Timer 1 kesme bayragi temizleniyor
}
...
void GPB_IRQHandler(void)
{
    ...
    if (((((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04040UL)))->INTSRC & ((0x00000800UL) ///< Bit 11 mask of an 32 bit integer)))
    {
        ((((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04040UL)))->INTSRC = ((0x00000800UL) ///< Bit 11 mask of an 32 bit integer));
       if ((*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((11)<<2))))==1) {
     TIMER_Start(((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL)));
      TIMER_ResetCounter(((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL)));
      }
     else {

      OlculenDeger=TIMER_GetCounter(((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL)));
      TIMER_Stop(((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL)));

       OlculenDeger=(OlculenDeger/465) / 2;


      //OlculenDeger=(OlculenDeger/1000); // Cm'e Çevrililiyor.
      printf("Mesafe %d cm\n", OlculenDeger);
    }
    ...
    {
        uint32_t u32Status;
        u32Status = ((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04040UL))->INTSRC;
         ((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04040UL))->INTSRC = u32Status;
...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((((0) & 0x03) << 30)|((((25)) & 0x1f) << 0)| (((0x0) & 0x03) << 28)|(((0x0) & 0x07) << 25)|(((0x0) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)));
...
int main(void)
{
    ...
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04040UL)), (0x00000800UL) ///< Bit 11 mask of an 32 bit integer, 0x0UL);
   GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04040UL)), (0x00000400UL) ///< Bit 10 mask of an 32 bit integer, 0x1UL);
    GPIO_EnableInt(((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04040UL)), 11, 0x00010001UL);
    __NVIC_EnableIRQ(GPB_IRQn);
    (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((10)<<2))))=0;
    (((GPIO_DBCTL_T *) (((uint32_t)0x40000000UL) + 0x04440UL))->DBCTL = ((0x003F0000UL) | (0x00000010UL) | (0x0000000AUL) ));
    TIMER_Open(((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL)), (1UL << (27)), 1); // Timer 1 yapilandirmasi
    TIMER_EnableInt(((TIMER_T *) (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL))); // Timer 1 kesmelerini etkinlestirin
    __NVIC_EnableIRQ(TMR1_IRQn); // Timer 1 kesmesi için ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) ) etkinlestirin
   ...
   (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((10)<<2))))=0;
  CLK_SysTickDelay(10);
    (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((10)<<2))))=1;
    CLK_SysTickDelay(10);
    (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((10)<<2))))=0;
